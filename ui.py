...
class MainWindow(QMainWindow):
    ...
    def _check_config(self) -> bool:
        ...
        try:
            ...
            # Check for gemini keys (support both single and multiple)
            has_gemini = bool(d.get("gemini_api_key")) or (bool(d.get("gemini_api_keys")) and len(d.get("gemini_api_keys", [])) > 0)
            return (has_gemini and
    ...
    def _on_setup_done(self, key: str, or_key: str, os_name: str):
        ...
        API_FILE.write_text(
            json.dumps({
                "gemini_api_keys":   [key],  # Store as array for future multiple keys support

...
- Use analyst for: research-based analysis, thinking about topics, economic/current events analysis, detailed explanations.
- Use web_search for: quick facts, simple searches, looking up specific data.
...
analyst
  topic: string (required) — topic to research and analyze
  research_depth: "quick" | "moderate" | "comprehensive" (optional, default: comprehensive)
  use_browser: boolean (optional) — use browser for research
